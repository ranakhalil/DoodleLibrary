window.onload = function () {
    ...
    var bezierUbg = new Path({
        ...
        type: "bezier",
        points: [
            { x: 340, y: 105 },// initial points
            { cp1x: 340, cp1y: 310, cp2x: 460, cp2y: 310, x: 460, y: 110 } // points to go through
            ]
    });
    var bezierU = new Path({
        ...
        type: "bezier",
        points: [
            { x: 340, y: 105 }, // initial coordinates
            { cp1x: 340, cp1y: 310, cp2x: 460, cp2y: 310, x: 460, y: 110 } // points to make the curve go through
            ]
    });

  //pushing curves to the doodle to draw
  ...
  // pushing the lines to the doodle to draw
 ...
 //pushing the packman arc and lines to the doodle to draw
    ...
    // draw everythign pushed previously
    doodle.draw();
};
